...
namespace Agent_s_App.ViewModel.Command.HomePageCommands.AccommodationServicesCommand
{
	public class AddServiceCommand : ICommand
	{
		...
		public AddServiceCommand(AccommodationServicesViewModel accommodationServicesViewModel)
		{
		...
		{
			AccommodationServicesViewModel.ServicePage = new ServiceView(null, AccommodationServicesViewModel);
		}
	}
}
